...
#
# Generated by Vivado on Tue Jan 16 00:13:05 +0800 2024
...
# Script info
echo -e "tb_top.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
simulate()
{
  vsim -64 -gui -do "do {simulate.do}" -l simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/Xilinx/vivado_lib/201902"
  fi
